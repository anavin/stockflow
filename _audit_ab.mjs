...
var mk = (arr) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Document, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Page, { size: "A4", style: { padding: 30, fontFamily: "NotoSansThai" }, children: arr.map((s2, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 11, fontFamily: "NotoSansThai" }, children: "|" + s2 + "|" }, i)) }) });
async function main() {
  writeFileSync("_audit_nospace.pdf", await renderToBuffer(mk(strings)));
  writeFileSync("_audit_space.pdf", await renderToBuffer(mk(strings.map((x) => x + " "))));
  console.log("done");
}
main().catch((e) => {
  console.error(e);
