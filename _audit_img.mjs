...
var rows = ["\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23", "\u0E23\u0E32\u0E0A\u0E32\u0E40\u0E17\u0E27\u0E30", "\u0E23\u0E27\u0E21\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E34\u0E49\u0E19", "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38", "\u0E17\u0E35\u0E48\u0E2D\u0E22\u0E39\u0E48", "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A \u0E2D\u0E19\u0E32\u0E27\u0E34\u0E19"];
var doc = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Document, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Page, { size: "A4", style: { padding: 40, fontFamily: "NotoSansThai" }, children: rows.map((s2, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 26, fontFamily: "NotoSansThai", marginBottom: 14 }, children: s2 }, i)) }) });
async function main() {
  writeFileSync("_audit_img.pdf", await renderToBuffer(doc));
  console.log("done");
}
main().catch((e) => {
  console.error(e);
