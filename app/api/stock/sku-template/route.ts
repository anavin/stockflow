 ...
 *  Barcode = บาร์โค้ดต่อกลิ่น/ขนาด (คงที่, ใช้เดากลิ่น/ขนาด) · SKU = เลขรายชิ้น (ไม่ซ้ำ, user กำหนดเอง) */
export async function GET() {
  ...
  [
    ...
    "• Barcode = บาร์โค้ดประจำกลิ่น/ขนาด (เลขเดียวกันได้หลายชิ้น) → ระบบจะเดากลิ่น/ขนาด/Grade ให้เอง",
