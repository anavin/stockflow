...
export default async function NewOrderPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 md:px-8">
      ...
      <OrderForm products={products} sizes={sizes} provinces={provinces} postcodes={postcodes} productCodes={productCodes} productTypes={productTypes} discontinued={discontinued} />
    </div>
  );
}
